                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="recipient-name" name="nama" placeholder="<?php echo Session::get('namaTPS')?>">
                                </div>
                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">Lokasi:</label>
                                    <input type="text" class="form-control" id="recipient-name" name="lokasi" placeholder="<?php echo Session::get('lokasiTPS')?>">
                                </div>
                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">Volume:</label>
                                    <input type="text" class="form-control" id="recipient-name" name="volume" placeholder="<?php echo Session::get('volumeTPS')?>">
                                </div>
                            </div>
